...
form.addEventListener('submit', async (e) => {
  ...
  const body = {
    editedAssets: form.editedAssets.value.trim(),
    channels: form.channels.value.trim(),
  ...
  outputEl.textContent = 'Packaging assets for distribution. This may take a minute...';
  ...
  try {
    ...
    submitBtn.textContent = 'Package for Distribution';
  }
});
