...
form.addEventListener('submit', async (e) => {
  ...
  const body = {
    campaignMeta: form.campaignMeta.value.trim(),
    platformMetrics: form.platformMetrics.value.trim(),
    qualitativeFeedback: form.qualitativeFeedback.value.trim(),
    humanNotes: form.humanNotes.value.trim(),
  ...
  outputEl.textContent = 'Analyzing campaign performance. This may take a minute...';
